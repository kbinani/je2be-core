...
public:
  ...
  static box360::detail::StfsFileEntry *FindSavegameFileEntry(box360::detail::StfsFileListing &listing) {
  ...
  static std::optional<SaveBin::SavegameInfo> ExtractSavagame(std::filesystem::path const &saveBinFile, std::vector<u8> &buffer) {
    ...
    try {
      auto pkg = make_unique<box360::detail::StfsPackage>(new box360::detail::FileIO2(saveBinFile));
