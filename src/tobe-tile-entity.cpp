...
#undef E
  ...
  static ListTagPtr GetItemsRemovingSlot(CompoundTagPtr const &c, std::string const &name, Context &ctx, size_t capacity) {
  ...
  static ListTagPtr GetItems(CompoundTagPtr const &c, std::string const &name, Context &ctx) {
