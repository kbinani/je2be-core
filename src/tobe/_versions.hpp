...
i32 constexpr kBlockDataVersion = 18095666;                                   // v1.20.30
Version constexpr kMinimumCompatibleClientVersion = Version(1, 20, 30, 0, 0); // v1.20.0
...
char8_t const *const kInventoryVersion = u8"1.20.1";                          // v1.20.1
